...
#ifndef _OSGMETADATAATTACHMENTBASE_H_
#define _OSGMETADATAATTACHMENTBASE_H_
#ifdef __sgi
#pragma once
#endif
...
#include "OSGMetaDataAttachmentFields.h"
...
//! \brief MetaDataAttachment Base Class.

class OSG_CONTRIBMETADATA_DLLMAPPING MetaDataAttachmentBase : public Attachment
{
  public:
    ...
    OSG_GEN_INTERNALPTR(MetaDataAttachment);
  ...
  public:
    ...
    static  MetaDataAttachmentTransitPtr  create          (void);
    static  MetaDataAttachment           *createEmpty     (void);

    static  MetaDataAttachmentTransitPtr  createLocal     (
                                               BitVector bFlags = FCLocal::All);

    static  MetaDataAttachment            *createEmptyLocal(
                                              BitVector bFlags = FCLocal::All);

    static  MetaDataAttachmentTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    MetaDataAttachmentBase(void);
    MetaDataAttachmentBase(const MetaDataAttachmentBase &source);
    ...
    virtual ~MetaDataAttachmentBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      MetaDataAttachmentBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const MetaDataAttachmentBase &source);
};

typedef MetaDataAttachmentBase *MetaDataAttachmentBaseP;

OSG_END_NAMESPACE

#endif /* _OSGMETADATAATTACHMENTBASE_H_ */
