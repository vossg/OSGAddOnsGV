...
inline 
const MFString &MetaDataAttachment::getKeys(void) const
{
    return *MetaDataAttachmentBase::getMFKeys();
}
...
inline 
bool MetaDataAttachment::hasAttribute(const std::string &key) const
{
...
inline 
const std::string MetaDataAttachment::getAttribute(const std::string &key) const
{
    std::string value;
...
inline 
std::string &MetaDataAttachment::operator[](const std::string &key)
{
