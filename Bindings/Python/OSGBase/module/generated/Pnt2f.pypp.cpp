...
void register_Pnt2f_class(){
    ...
    { //::OSG::Point< float, 2u >
        ...
        { //::OSG::Point< float, 2u >::maxDim
            ...
            Pnt2f_exposer.def( 
                "maxDim"
                , maxDim_function_type( &::OSG::Point< float, 2u >::maxDim ) );
        
        }
        { //::OSG::Point< float, 2u >::maxDimAbs
            ...
            Pnt2f_exposer.def( 
                "maxDimAbs"
                , maxDimAbs_function_type( &::OSG::Point< float, 2u >::maxDimAbs ) );
