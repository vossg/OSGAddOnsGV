...
//
//	Description			:		GeometryClipmaps.cpp
//
//-------------------------------------------------------------------------------------------------
...
namespace OSG
{
	...
	bool GeometryClipmaps::initialize( int requestedLevelSize, HeightDataSource* heightSource, TextureDataSource* textureSource )
	{
	...
	bool GeometryClipmaps::findFirstIntersection( const Line& line, Real32& t, Vec3f& normal )
	{
		//todo: implement this
		return false;
	}
