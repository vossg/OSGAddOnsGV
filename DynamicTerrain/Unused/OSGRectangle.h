...
template< typename T > Rectangle2< T >	
alignRectangle( const Rectangle2< T >& rect, 
                const typename Rectangle2< T >::PointType& alignment );

template< typename T > Rectangle2< T >	
getIntersection( const Rectangle2< T >& lhs, const Rectangle2< T >& rhs );

template< typename T > Rectangle2< T >	
getUnion( const Rectangle2< T >& lhs, const Rectangle2< T >& rhs );
