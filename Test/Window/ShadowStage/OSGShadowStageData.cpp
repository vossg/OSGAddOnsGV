...
// OSGShadowStageDataBase.cpp file.
// To modify it, please change the .fcd file (OSGShadowStageData.fcd) and
...
void ShadowStageData::initMethod(InitPhase ePhase)
{
...
void ShadowStageData::changed(ConstFieldMaskArg whichField, 
                              UInt32            origin,
                              BitVector         details)
{
...
void ShadowStageData::dump(      UInt32    ,
                           const BitVector ) const
{
    SLOG << "Dump ShadowStageData NI" << std::endl;
}
