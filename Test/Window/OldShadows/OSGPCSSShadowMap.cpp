...
void PCSSShadowMap::createShadowMapsFBO(DrawEnv *pEnv)
{
...
void PCSSShadowMap::createColorMap(DrawEnv *pEnv)
{
...
void PCSSShadowMap::createColorMapFBO(DrawEnv *pEnv)
{
...
void PCSSShadowMap::createShadowFactorMapFBO(DrawEnv *pEnv,
                                             UInt32 num)
{
    glClearColor(0.0, 0.0, 0.0, 1.0);
...
void PCSSShadowMap::createShadowFactorMap(DrawEnv *pEnv, UInt32 num)
{
    glClearColor(0.0, 0.0, 0.0, 1.0);
    if(_firstRun)
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
void PCSSShadowMap::drawCombineMap(DrawEnv *pEnv)
{
    Real32  xFactor = 1.0;
    Real32  yFactor = 1.0;
    if(!_useNPOTTextures)
