...
bool VarianceShadowMap::initFBO(DrawEnv *pEnv)
{
    if(!_texChanged)
    {
...
void VarianceShadowMap::reInit(DrawEnv *pEnv)
{
#ifdef USE_FBO_FOR_COLOR_AND_FACTOR_MAP
    Int32   width = _shadowVP->getPixelWidth();
    Int32   height = _shadowVP->getPixelHeight();
...
void VarianceShadowMap::createShadowMapsFBO(DrawEnv *pEnv)
{
...
void VarianceShadowMap::createColorMap(DrawEnv *pEnv)
{
...
void VarianceShadowMap::createColorMapFBO(DrawEnv *pEnv)
{
    glClearColor(0.0, 0.0, 0.0, 1.0);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
void VarianceShadowMap::createShadowFactorMap(DrawEnv *pEnv,
                                              UInt32 num)
{
    glClearColor(0.0, 0.0, 0.0, 1.0);
    if(_firstRun)
...
void VarianceShadowMap::createShadowFactorMapFBO(DrawEnv *pEnv,
                                                 UInt32 num)
{
    glClearColor(0.0, 0.0, 0.0, 1.0);
...
void VarianceShadowMap::drawCombineMap(DrawEnv *pEnv)
{
    Real32  xFactor = 1.0;
    Real32  yFactor = 1.0;
    if(!_useNPOTTextures)
...
void VarianceShadowMap::render(DrawEnv *pEnv)
{
    Window  *win = pEnv->getWindow();
    initialize(win);
