...
#ifndef MFEDIT_INDEXING_SUITE_JDG20036_HPP
# define MFEDIT_INDEXING_SUITE_JDG20036_HPP
...
namespace boost { namespace python {
    ...
    class mfedit_indexing_suite;
    
    namespace detail
    {
        template <class Container, bool NoProxy>
        class final_mfedit_derived_policies
            : public mfedit_indexing_suite<Container,
                NoProxy, final_mfedit_derived_policies<Container, NoProxy> > {};
    }
    ...
    template <
        ...
        class DerivedPolicies 
            = detail::final_mfedit_derived_policies<Container, NoProxy> >
    class mfedit_indexing_suite
