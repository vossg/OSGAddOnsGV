...
# MFPtrAccessTestBase:
#
# Base class for testing the integrity of a pointer multi-field when accessing it
# with the access methods provided in the PyFieldAccessHandler class.
#-------------------------------------------------------------------------------
...
class MFUnrecPtrAccessTest(MFRecPtrAccessTest):
    def __init__(self, fieldname, fieldidx, accesshandler):
        # Just a dummy class derived from MFRecPtrAccessTest for clearer naming
        # of the test 
        MFPtrAccessTestBase.__init__(self, fieldname, fieldidx, accesshandler)
