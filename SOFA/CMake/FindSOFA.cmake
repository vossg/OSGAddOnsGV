...
#    MESSAGE("FOOOO ROOT: ${SOFA_ROOT}")
    ...
    FIND_PATH(SOFA_EIGEN_INCLUDE_DIR Eigen/Core
        PATHS ${SOFA_ROOT} ENV SOFA_ROOT
        PATH_SUFFIXES extlibs/eigen-3.1.1)

    IF(SOFA_EIGEN_INCLUDE_DIR)
      LIST(APPEND SOFA_INCLUDE_DIRS ${SOFA_EIGEN_INCLUDE_DIR})
    ENDIF(SOFA_EIGEN_INCLUDE_DIR)
