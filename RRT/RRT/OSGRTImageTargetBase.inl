...
inline
OSG::UInt32 RTImageTargetBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 RTImageTargetBase::getClassGroupId(void)
{
...
inline
ImagePtrConst RTImageTargetBase::getImage(void) const
{
...
inline
void RTImageTargetBase::setImage(ImagePtrConstArg value)
{
