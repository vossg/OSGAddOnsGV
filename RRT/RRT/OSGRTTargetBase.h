...
#ifndef _OSGRTTARGETBASE_H_
#define _OSGRTTARGETBASE_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_CONTRIBRRT_DLLMAPPING RTTargetBase : public FieldContainer
{
  ...
  public:
    ...
    static  RTTargetTransitPtr  createDependent  (BitVector bFlags);
  ...
  protected:
    ...
    RTTargetBase(void);
    RTTargetBase(const RTTargetBase &source);
