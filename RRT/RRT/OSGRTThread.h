...
#ifndef _OSGRTTHREAD_H_
#define _OSGRTTHREAD_H_
#ifdef __sgi
#pragma once
#endif
...
class OSG_CONTRIBRRT_DLLMAPPING RTThread : public OSG::BaseThread
{
  ...
  protected:
    ...
    typedef OSG::BaseThread    Inherited;
...
#include "OSGRTThread.inl"

#endif /* _OSGPTTHREAD_H_ */
