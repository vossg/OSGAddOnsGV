...
PointerType FieldTraits<RTImageTarget *, nsOSG>::_type(
    "RTImageTargetPtr", 
    "RTTargetPtr", 
    RTImageTarget::getClassType(),
    nsOSG);
#endif
...
RTImageTargetTransitPtr RTImageTargetBase::createDependent(BitVector bFlags)
{
    RTImageTargetTransitPtr fc;
...
FieldContainerTransitPtr RTImageTargetBase::shallowCopyDependent(
    BitVector bFlags) const
{
    RTImageTarget *tmpPtr;
                                  ...
                                  const UInt32             uiSyncInfo)
{
    ...
    pThis->execSync(static_cast<RTImageTarget *>(&oFrom),
                    whichField,
                    oOffsets,
                    syncMode,
                    uiSyncInfo);
