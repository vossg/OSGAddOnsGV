...
DataType FieldTraits<RTCacheAttachment *, nsOSG>::_type("RTCacheAttachmentPtr", "AttachmentPtr", nsOSG);
#endif

OSG_FIELDTRAITS_GETTYPE_NS(RTCacheAttachment *, nsOSG)
...
{
    RTCacheAttachment *pThis = static_cast<RTCacheAttachment *>(this);

    pThis->execSync(static_cast<RTCacheAttachment *>(&oFrom),
                    whichField,
                    oOffsets,
                    syncMode,
                    uiSyncInfo);
...
#ifdef OSG_MT_CPTR_ASPECT
FieldContainer *RTCacheAttachmentBase::createAspectCopy(
    const FieldContainer *pRefAspect) const
{
    RTCacheAttachment *returnValue;

    newAspectCopy(returnValue,
                  dynamic_cast<const RTCacheAttachment *>(pRefAspect),
                  dynamic_cast<const RTCacheAttachment *>(this));
