...
template< typename T > Rectangle2< T >::Rectangle2( 
    const PointType& p, T width, T height )
{
    x0 = p[ 0 ];
    y0 = p[ 1 ];
    x1 = x0 + width;
...
template< typename T > Rectangle2< T >::Rectangle2(const PointType& p, 
                                                   const PointType& s )
{
    x0 = p[ 0 ];
    y0 = p[ 1 ];
...
template< typename T >	bool Rectangle2< T >::contains( 
...
template< typename T >	bool Rectangle2< T >::intersects( 
    const Rectangle2& r ) const
{
...
template< typename T > void Rectangle2< T >::crop( 
    const Rectangle2< T >& boundary, 
    const T& borderSize )
{
...
template Rectangle2< float > getIntersection( const Rectangle2< float >& lhs, 
                                              const Rectangle2< float >& rhs );
template Rectangle2< float > getUnion( const Rectangle2< float >& lhs, 
                                       const Rectangle2< float >& rhs );

template Rectangle2< double > getIntersection(const Rectangle2< double >& lhs,
                                              const Rectangle2< double >& rhs);
template Rectangle2< double > getUnion( const Rectangle2< double >& lhs, 
                                        const Rectangle2< double >& rhs );

template Rectangle2< int > getIntersection( const Rectangle2< int >& lhs, 
                                            const Rectangle2< int >& rhs );
template Rectangle2< int > getUnion( const Rectangle2< int >& lhs, 
                                     const Rectangle2< int >& rhs );
